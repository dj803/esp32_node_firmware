...
void loop() {
    ...
    // The flag is set inside onMqttDisconnect() and cleared here immediately so
    // it only triggers once per threshold crossing.
    if (mqttFailCount() >= MQTT_RESTART_THRESHOLD) {
