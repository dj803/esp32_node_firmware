...
### D. Open stability investigations (3) — #78 + #96 SHIPPED in v0.4.28; #97 SHIPPED in v0.4.29
  ...
  #98   Heartbeat / device-status reconnect needs to be faster after router power failure   (filed 2026-04-29 PM — real-world router+power outage post-v0.4.29-tag; 10+ min after broker recovery, all 6 devices' heartbeat LEDs blinking but ZERO fresh MQTT messages reached broker. Likely root cause: WiFi backoff saturates at 600 s after 5 failed attempts; FIX OPTIONS in archive — (a) SSID probe during 600 s wait, (b) reset backoff on WiFi-association success, (c) compress schedule to cap at 300 s, (d) sibling-MAC ping for fast-track. Operator-quality-of-life HIGH priority)
...
### G. Docs / process / long-tail closure (4) — #95/#97 SHIPPED in v0.4.29
  ...
  Total open: 25  (A6 + B9 + C0 + D3 + E0 + F1 + G6) — net delta 2026-04-29 v0.4.29: -3 from B group (#87/#88/#89 RESOLVED), -2 from G group (#95/#97 RESOLVED), +1 from D group (#98 filed post-router-failure). Detailed entries in SUGGESTED_IMPROVEMENTS_ARCHIVE.md
