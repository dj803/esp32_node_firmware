...
### D. Open stability investigations (2) — #78 + #96 SHIPPED in v0.4.28; #97 SHIPPED in v0.4.29
...
### G. Docs / process / long-tail closure (4) — #95/#97 SHIPPED in v0.4.29
  ...
  Total open: 24  (A6 + B9 + C0 + D2 + E0 + F1 + G6) — net delta 2026-04-29 v0.4.29: -3 from B group (#87/#88/#89 RESOLVED), -2 from G group (#95/#97 RESOLVED). Detailed entries in SUGGESTED_IMPROVEMENTS_ARCHIVE.md
