...
### G. Docs / process / long-tail closure (6) — mostly validation-pending, not coding
  ...
  #97   Auto-OTA-during-cascade-recovery gate                                (filed 2026-04-29 PM — fleet OTA'd v0.4.26→v0.4.27 mid-cascade-recovery during AP-cycle #2; heap state post-cascade is unknown. Proposed: gate `otaCheckNow()` on the existing `_lastNetworkDisconnectMs` with a 5 min quiet window. Bundle into v0.4.29 alongside #87/#88/#89; full text in archive)

  Total open: 29  (A6 + B12 + C0 + D1 + E0 + F1 + G9) — net delta 2026-04-29: +6 from Phase 2 R1 (#86-#91), +1 morning cascade (#92), +1 serial-silence (#93), +1 #94 patches, +1 PIO Unicode (#95), +1 long-outage AP-mode loop (#96 — shipped v0.4.28), +1 auto-OTA gate (#97 — v0.4.29 candidate); -1 #54 RESOLVED, -1 #78 RESOLVED v0.4.28, -1 #96 RESOLVED v0.4.28. Detailed entries in SUGGESTED_IMPROVEMENTS_ARCHIVE.md
